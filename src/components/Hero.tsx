    ...
    <header className="hero" id="hero-section">
      ...
      <div className="hero-content">
        <h1 className="hero-title" data-aos="fade-up">
          <span className="hero-line" data-aos="fade-up" data-aos-delay="0">
            SOFIA DARKE
          </span>
          <span className="hero-line" data-aos="fade-up" data-aos-delay="100">
            FULLSTACK DEVELOPER
          </span>
          <span className="hero-line" data-aos="fade-up" data-aos-delay="200">
            STOCKHOLM — SE
          </span>
        </h1>
